...
// 这些常量通常用于在代码中设置或者检查某些状态。例如可能会有这样的代码：
// if (vnode.flags & MODE_HYDRATE) {
//   // do something
// }
// 这段代码检查了 vnode.flags 是否包含 MODE_HYDRATE 标志
// 比如 vnode.flags 包含了 MODE_HYDRATE，那这个vnode.flags的值至少应该是 32，也就是 MODE_HYDRATE 的值
// 如果 vnode.flags 同时包含 MODE_HYDRATE 和 MODE_SUSPENDED，那么 vnode.flags 的值应该是 32 + 128 = 160
